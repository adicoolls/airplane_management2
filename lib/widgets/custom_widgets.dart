...
Widget buildSearchButton(BuildContext context,
    {required String from, required String to, String? date}) {
  return ElevatedButton(
    onPressed: () {
      ...
      if (from.isNotEmpty && to.isNotEmpty && from != "null" && to != "null") {
        // Split the airport string and get only the airport name
        final fromAirport = from.split('_').first.trim();
        final toAirport = to.split('_').first.trim();

        log('From processed: $fromAirport');
        log('To processed: $toAirport');
